...
import com.example.pc.appbandh.adapter.NamAdapter;
...
public class NamActivity extends AppCompatActivity {
    ...
    private void LoadMoreData() {
        lvn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("thongtinsp",mangnam.get(i));
                startActivity(intent);
            }
        });
        lvn.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response != null && response.length()!=2){
                    lvn.removeFooterView(footerview);
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length();i++){
                            ...
                            mangnam.add(new sanpham(ID,Idlsp,Tensanpham,Giasanpham,Mota,Hinhanhsanpham));
                            namAdapter.notifyDataSetChanged();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idlsp",String.valueOf(iddhn));
                return param;
            }
        };
    ...
    private void ActionToolBar() {
        setSupportActionBar(toolbardhn);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbardhn.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void GetIdloaisp() {
        iddhn=getIntent().getIntExtra("idloaisanpham",-1);
        Log.d("giatriloaisp",iddhn+"");
    }

    private void Anhxa() {
        toolbardhn= (Toolbar) findViewById(R.id.toolbarnam);
        lvn= (ListView) findViewById(R.id.listviewnam);
        mangnam=new ArrayList<>();
        namAdapter=new NamAdapter(getApplicationContext(),mangnam);
        lvn.setAdapter(namAdapter);
